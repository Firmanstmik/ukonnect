...
function reveal(delay: number, distance: number, reduced: boolean) {
    return {
        ...
        transition: { duration: reduced ? 0 : 0.76, delay: reduced ? 0 : delay, ease: EASE },
    };
}
...
export const Hero = () => {
    ...
    return (
        <>
            <section
                ref={sectionRef}
                className="cinematic-hero relative isolate overflow-x-clip overflow-y-visible pb-[calc(6.5rem+env(safe-area-inset-bottom))] pt-28 sm:pt-36 md:pb-20 lg:flex lg:h-[100svh] lg:min-h-[720px] lg:max-h-[900px] lg:flex-col lg:overflow-hidden lg:pb-0 lg:pt-[5.75rem]"
            >
                <HeroBackground />
                ...
                <div className="site-gutter-x relative mx-auto flex w-full max-w-none flex-1 flex-col lg:min-h-0">
                    <div className="cinematic-hero-canvas relative flex flex-1 flex-col lg:min-h-0 lg:grid lg:grid-cols-[minmax(24rem,1.22fr)_minmax(540px,700px)] lg:items-center lg:gap-x-10 lg:pb-12 xl:grid-cols-[minmax(26rem,1.28fr)_minmax(560px,720px)] xl:gap-x-14">
                        <header className="cinematic-hero-copy relative z-20 mx-auto flex w-full max-w-[1120px] flex-col items-center text-center lg:mx-0 lg:min-h-0 lg:max-w-none lg:items-start lg:justify-center lg:self-center lg:pr-2 lg:text-left xl:pr-4">
                            <motion.h1
                                {...reveal(0.08, 24, reduced)}
                                className="cinematic-headline mt-1 max-w-[1100px] text-balance text-[2.55rem] leading-[1.02] sm:text-[3.6rem] lg:mt-0 lg:max-w-[22ch] lg:text-[2.95rem] xl:max-w-[24ch] xl:text-[3.25rem]"
                            >
                            ...
                            >
                                <motion.button
                                    ...
                                    className="hero-btn-ref px-8 py-3.5 text-[15px] font-semibold text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#5b00e8] focus-visible:ring-offset-2"
                                >
                                    {t('hero.cta')}
                                </motion.button>
                        ...
                        <motion.div
                            className="cinematic-hero-stage-wrap relative z-10 mx-auto mt-1 w-full sm:mt-2 md:-mt-12 lg:mx-0 lg:mt-0 lg:ml-5 lg:flex lg:w-full lg:max-w-none lg:shrink-0 lg:items-center lg:justify-end xl:ml-8"
                            style={{ y: stageY }}
                    ...
                    <div className="cinematic-handoff relative z-[6] mx-auto -mt-1 flex h-28 w-44 flex-col items-center sm:-mt-2 lg:absolute lg:bottom-[0.65rem] lg:left-1/2 lg:m-0 lg:h-20 lg:-translate-x-1/2">
                        <motion.span className="cinematic-handoff-line" style={{ scaleY: handoffScale }} aria-hidden />
                        <span className="cinematic-handoff-particle" aria-hidden />
                        <small>{t('hero.scrollExplore')}</small>
                    </div>
                </div>
