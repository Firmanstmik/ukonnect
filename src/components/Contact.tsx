...
const STATS = [
    { value: '4,000+', label: 'companies trust us' },
        ...
        <>
            ...
            <section className="relative pt-40 pb-10 px-6 overflow-hidden text-center">
                ...
                <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, delay: 0.07 }}
                    ...
                    Let's talk about<br /><span className="text-[#5600e3]">your growth</span>
                </motion.h1>
                <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, delay: 0.14 }}
                    ...
                    Tell us what you're building. We'll map out the exact AI system to accelerate it — no fluff, no obligations.
                </motion.p>
                    ...
                    <div className="flex flex-col gap-6 h-full">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                                <div className="grid grid-cols-3 gap-3">
                                    <motion.a href="https://wa.me/310853331000" target="_blank" rel="noopener noreferrer"
                                        ...
                                        <p className="text-white font-bold text-xs">WhatsApp</p>
                                    </motion.a>
                                    <motion.a href="mailto:info@ukonnect.nl"
                                        ...
                                        <p className="text-white font-bold text-xs">E-mail</p>
                                    </motion.a>
                                    <motion.a href="tel:+310853331000"
                                        ...
                                        <p className="text-white font-bold text-xs">Phone</p>
                                    </motion.a>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div {...fadeUp(0.08)} className="relative rounded-[2.5rem] overflow-hidden flex-1" style={{ minHeight: '280px' }}>
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-6 flex items-end justify-between">
                                <div>
                                    <p className="text-white/60 text-xs font-semibold uppercase tracking-widest mb-1">The team</p>
                                    <p className="text-white text-lg font-bold leading-snug">The people behind your growth</p>
                                </div>
                        ...
                        <AnimatePresence mode="wait" custom={direction}>
                            ...
                            {view === 'calendar' && (
                                <motion.div key="calendar" custom={direction} variants={slideVariants} initial="enter" animate="center" exit="exit"
                                    ...
                                    <div className="flex items-center gap-3 px-8 pt-8 pb-4">
                                        ...
                                        <div>
                                            <p className="text-xs text-slate-400 font-medium">Schedule a meeting</p>
                                            <p className="text-sm font-semibold text-slate-900">Pick a date & time</p>
                                        </div>
                                    </div>
                            ...
                            {view === 'form' && (
                                <motion.form key="form" custom={direction} variants={slideVariants} initial="enter" animate="center" exit="exit"
                                    ...
                                    <div className="grid sm:grid-cols-2 gap-4">
                                        <div className="flex flex-col gap-1.5">
                                            <label className="text-sm font-medium text-slate-700">Company <span className="text-slate-400 font-normal">(optional)</span></label>
                                    ...
                                    <div className="flex flex-col gap-3">
                                        <label className="text-sm font-medium text-slate-700">I want to know more about:</label>
